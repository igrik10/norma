...
class FME_Layerednav_Block_Layer_Filter_Attribute extends Mage_Catalog_Block_Layer_Filter_Attribute {
    ...
    public function getFiltersArray() {
        ...
        foreach ($this->getItems() as $_item) {
			...
			$checked = ($this->Selectedfilter($_item) ? 'checked' : '');
            ...
            if ($this->getName() == "Color") {
                ...
                if ($showSwatches == "iconslinks") {
                    ...
                    $_html = "";
                    $_html .= '<label onchange="clickToFilter(this)"><input type="checkbox" '.$checked.' name="promo" value="on"/><a ' . $_htmlFilters . '>' . $_item->getLabel() . $qty .'</a></label>';
                }
            }
            ...
            if ($this->getName() == "Color") {
                ...
                $_filtersArray[] = '<label onchange="clickToFilter(this)"><input type="checkbox" '.$checked.' name="promo" value="on"/><a ' . $_htmlFilters . '>' . $_item->getLabel() . $qty .'</a></label>';
            }
        }
