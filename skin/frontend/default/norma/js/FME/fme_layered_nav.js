...
function create_price_slider(width, from, to, min_price, max_price, sKey)
{
    ...
    return new Control.Slider(price_slider.select('.handle'), price_slider, {
        ...
        onSlide: function(values) {
			jQuery('#price_range_from' + sKey).val(calculateSliderPrice(width, from, to, min_price, max_price, values[0]));
			jQuery('#price_range_to' + sKey).val(calculateSliderPrice(width, from, to, min_price, max_price, values[1])); 
