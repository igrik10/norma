...
var LoginPopup = Class.create({
    initialize: function (options) {
        ...
        this.login_form_div = $('magegiant-login-form');
        this.login_button = $('magegiant-button-sociallogin');
		this.forgot_form_div = $('forgot-password-form-div');
        ...
        this.invalid_email_forgot = $('magegiant-invalid-email-forgot');
        this.ajax_forgot = $('progress_image_login_forgot');

        this.create_customer = $('magegiant-create-user');
...
function openSocial(url, title) {
    var ssPopup = new SocialPopup();
